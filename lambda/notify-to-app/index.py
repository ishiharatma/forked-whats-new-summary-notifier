...
Your readers have the following characteristics:
- Have basic knowledge of AWS services
- Want to understand AWS blog articles efficiently and quickly
...
<instruction>
Analyze the AWS blog article in <input></input> tags and extract key information in bullet points covering:
- Main topic and purpose of the blog post
...
<outputLanguage>In {language}.</outputLanguage>
<summaryRule>
The final summary must consist of 2-3 sentences and should be written in plain language that busy AWS practitioners can quickly understand. The summary should capture:
1. The main topic/purpose of the blog
2. Key takeaway or practical benefit
